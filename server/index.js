  ...
  try {
    ...
    jsonLdScripts.each((i, elem) => {
      try {
        ...
        if (
          ...
          (Array.isArray(jsonData) && jsonData[0]?.["@type"] === "Course")
        ) {
          ...
          courses.push({
            ...
            instructor:
              courseData.provider?.name || courseData.author?.name || "Unknown",
          });
        }
      } catch (e) {
        // Skip invalid JSON
    ...
    if (courses.length === 0) {
      $('[data-purpose="course-card"]').each((i, elem) => {
        const $elem = $(elem);
        const title =
          $elem.find('[data-purpose="course-title-url"]').text().trim() ||
          $elem.find("h3, h4").first().text().trim();
        const description =
          $elem.find('[data-purpose="course-headline"]').text().trim() || "";
        const rating = parseFloat(
          $elem.find('[data-purpose="rating-number"]').text().trim() || "0",
        );
        const students =
          $elem.find('[data-purpose="rating-text"]').text().trim() || "";
...
async function parseCourseraCourses(html) {
  ...
  try {
      ...
      try {
        ...
        if (
          ...
          (Array.isArray(jsonData) &&
            jsonData.some((item) => item["@type"] === "Course"))
        ) {
    ...
    if (courses.length === 0) {
      $(
        '[data-testid="course-card"], .rc-CourseCard, [class*="CourseCard"]',
      ).each((i, elem) => {
        const $elem = $(elem);
        const title = $elem
        ...
        const description =
          $elem
            .find('[class*="description"], [class*="headline"]')
            .first()
            .text()
            .trim() || "";
        const rating = parseFloat(
          $elem.find('[class*="rating"]').first().text().trim() || "0",
        );
        const url = $elem.find("a").first().attr("href") || "";
        const image = $elem.find("img").first().attr("src") || "";
    ...
    const courses = [
      {
        ...
        description:
          "Learn Python from scratch. Master variables, loops, functions, and object-oriented programming. Build real-world projects and applications.",
        provider: "Udemy",
        url: "#",
        rating: 4.7,
      ...
      },
      {
        ...
        description:
          "Complete JavaScript course covering ES6+, async/await, DOM manipulation, and modern frameworks. Build interactive web applications.",
        provider: "Udemy",
        url: "#",
        rating: 4.8,
      ...
      },
      {
        ...
        description:
          "Master React.js with hooks, context API, routing, and state management. Build scalable single-page applications.",
        provider: "Udemy",
        url: "#",
        rating: 4.9,
      ...
      },
      {
        ...
        description:
          "Learn fundamental data structures and algorithms. Master problem-solving techniques for technical interviews.",
        provider: "Udemy",
        url: "#",
        rating: 4.6,
      ...
      },
      {
        ...
        description:
          "Introduction to machine learning concepts, algorithms, and practical applications. Build your first ML models.",
        provider: "Udemy",
        url: "#",
        rating: 4.7,
      ...
      },
      {
        ...
        description:
          "Full-stack web development course covering HTML, CSS, JavaScript, Node.js, and databases. Build complete web applications.",
        provider: "Udemy",
        url: "#",
        rating: 4.8,
      ...
      },
      {
        ...
        description:
          "Improve your English language skills for professional success. Learn business writing, communication, and interview techniques.",
        provider: "Udemy",
        url: "#",
        rating: 4.8,
      ...
      },
      {
        ...
        description:
          "Learn Spanish from basics to advanced. Master grammar, vocabulary, conversation, and cultural nuances.",
        provider: "Udemy",
        url: "#",
        rating: 4.6,
      ...
      },
      {
        ...
        description:
          "Learn SEO, social media marketing, content marketing, and analytics. Build effective digital marketing campaigns.",
        provider: "Udemy",
        url: "#",
        rating: 4.7,
      ...
      },
      {
        ...
        description:
          "Master user interface and user experience design. Learn design principles, prototyping, and user research methods.",
        provider: "Udemy",
        url: "#",
        rating: 4.8,
      ...
      },
      {
        ...
        description:
          "Learn Amazon Web Services (AWS) from basics. Master EC2, S3, Lambda, and cloud architecture patterns.",
        provider: "Udemy",
        url: "#",
        rating: 4.7,
      ...
      },
      {
        ...
        description:
          "Build cross-platform mobile apps with Flutter and Dart. Create beautiful, performant apps for iOS and Android.",
        provider: "Udemy",
        url: "#",
        rating: 4.8,
  ...
  app
    ...
    .on("error", (err) => {
      if (err.code === "EADDRINUSE") {
        console.error(
          `Port ${PORT} is already in use. Please stop the other server or change the PORT.`,
        );
      } else {
        console.error("Server error:", err);
      }
