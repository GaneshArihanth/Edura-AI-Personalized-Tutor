      ...
      <section className="relative flex min-h-[calc(100vh-4rem)] items-center overflow-hidden py-16">
        ...
        <div className="container relative z-10 px-4">
          <motion.div
            ...
            className="pointer-events-none mx-auto flex max-w-4xl flex-col items-center text-center pt-24 pb-12 sm:pt-32 md:pt-40"
          >
              ...
              >
                ...
                <span
                  className={cn(
                    ...
                    isDark
                      ? 'bg-gradient-cosmic'
                      : 'bg-gradient-to-r from-[#7C3AED] via-[#8B5CF6] to-[#7C3AED]',
                  )}
                >
                  Edura
                </span>
        ...
        <div className="container px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {features.map((feature, index) => (
              ...
              >
                <div className="h-full p-6 glass-card rounded-2xl group transition-transform hover:-translate-y-1">
